...
PANEL_2_SKEW = mat_scale_2d(1.1 * GLOBAL_SCALE)
PANEL_2_OFFSET = (0.09 * GLOBAL_SCALE, 0.11 * GLOBAL_SCALE)
PANEL_3_SKEW = np.matrix([[-1.1 * GLOBAL_SCALE, 0], [0, 1.1 * GLOBAL_SCALE]])
PANEL_3_OFFSET = (-0.09 * GLOBAL_SCALE, 0.11 * GLOBAL_SCALE)
CTRL_1_ROT = (1 * 360 / 5)
CTRL_2_ROT = (2 * 360 / 5)
CTRL_3_ROT = (3 * 360 / 5)
CTRL_4_ROT = (4 * 360 / 5)
...
PANELS = OrderedDict([
    (0, [
        ...
        (3, 'outer', PANEL_3_SKEW, (CTRL_1_ROT + CTRL_1_ROT), rotate_vector(PANEL_3_OFFSET, (CTRL_1_ROT + CTRL_1_ROT))),
    ]),
    (1, [
        ...
        (3, 'outer', PANEL_3_SKEW, (CTRL_2_ROT + CTRL_1_ROT), rotate_vector(PANEL_3_OFFSET, (CTRL_2_ROT + CTRL_1_ROT))),
    ]),
    (2, [
        ...
        (3, 'outer', PANEL_3_SKEW, (CTRL_3_ROT + CTRL_1_ROT), rotate_vector(PANEL_3_OFFSET, (CTRL_3_ROT + CTRL_1_ROT))),
    ]),
    (3, [
        ...
        (3, 'outer', PANEL_3_SKEW, (CTRL_4_ROT + CTRL_1_ROT), rotate_vector(PANEL_3_OFFSET, (CTRL_4_ROT + CTRL_1_ROT))),
    ]),
    (4, [
