...
PANEL_2_SKEW = mat_scale_2d_y(0.95) * mat_rotation_2d(60) * mat_scale_2d(0.5 * GLOBAL_SCALE)
PANEL_2_OFFSET = (0, 0.5 * GLOBAL_SCALE)
CTRL_1_ROT = (1 * 360 / 5)
CTRL_2_ROT = (2 * 360 / 5)
CTRL_3_ROT = (3 * 360 / 5)
CTRL_4_ROT = (4 * 360 / 5)
...
PANELS = OrderedDict([
    (0, [
        ...
        # (2, 'smol', PANEL_2_SKEW, CTRL_1_ROT, rotate_vector(PANEL_2_OFFSET, CTRL_1_ROT)),
        # (3, 'smol')
    ]),
    (1, [
